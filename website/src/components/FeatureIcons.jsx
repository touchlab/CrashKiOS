...
export function WarningSign() {
    return (
        <>{CircleBlock(() => {
            return (
                    <g stroke-linecap="square" stroke-width="2" fill="none" className="stroke-current text-amber-100" stroke-linejoin="miter"
                       className="nc-icon-wrapper" stroke-miterlimit="10">
                        <g transform="translate(20 19)">
                            <path
                                className="stroke-current text-amber-100"
                            ...
                            <line x1="12" y1="8" x2="12" y2="14" className="stroke-current text-amber-300"></line>
                            <circle cx="12" cy="17.5" r="1.5" stroke="none" className="fill-current text-amber-300"></circle>
                        </g>
                    </g>
            )
        })}</>
